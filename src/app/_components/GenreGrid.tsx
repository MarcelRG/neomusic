          ...
          {search?.map((g, index) => {
            ...
            return (
              <div key={g.id} className="relative">
                ...
                <div
                  className={`
                  absolute -left-2 -top-2 z-[1] flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold shadow-lg
                  ${
                    isSelected
                ...
                >
                  ...
                  <span
                    className={`
                    relative text-center font-medium leading-tight
                    ${
                      isSelected
                        ? "text-white"
